          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                <div className={`h-2 w-2 rounded-full ${otherUser.isOnline ? 'bg-green-400' : 'bg-gray-400'}`}></div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          ...
          messages.map((message) => (
            <div
              key={message._id}
              className={`flex ${message.sender._id === otherUser._id ? 'justify-start' : 'justify-end'}`}
            >
